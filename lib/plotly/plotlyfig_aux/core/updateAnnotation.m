...
if( exist( 'OCTAVE_VERSION', 'builtin' ) )
  text_data.HorizontalAlignment = text_data.horizontalalignment;
  text_data.VerticalAlignment = text_data.verticalalignment;
  text_data.Interpreter = text_data.interpreter;
  text_data.String = text_data.string;
  text_data.Position = text_data.position;
  text_data.Color = text_data.color;
  text_data.FontName = text_data.fontname;
  text_data.FontSize = text_data.fontsize;
  text_data.FontWeight = text_data.fontweight;
  text_data.BackgroundColor = text_data.backgroundcolor;
  text_data.BackgroundColor = text_data.backgroundcolor;
  text_data.EdgeColor = text_data.edgecolor;
  text_data.Rotation = text_data.rotation;
  text_data.LineWidth = text_data.linewidth;
  text_data.Margin = text_data.margin;
  text_data.Visible = text_data.visible;
end
