...
if( exist( 'OCTAVE_VERSION', 'builtin' ) )
  axis_data.Position = axis_data.position;
  axis_data.FontSize = axis_data.fontsize;
  axis_data.XAxisLocation = axis_data.xaxislocation;
  axis_data.YAxisLocation = axis_data.yaxislocation;
  axis_data.FontName = axis_data.fontname;
  axis_data.TickLength = axis_data.ticklength;
  axis_data.XColor = axis_data.xcolor;
  axis_data.YColor = axis_data.ycolor;
  axis_data.XGrid = axis_data.xgrid;
  axis_data.YGrid = axis_data.ygrid;
  axis_data.XMinorGrid = axis_data.xminorgrid;
  axis_data.YMinorGrid = axis_data.yminorgrid;
  axis_data.LineWidth = axis_data.linewidth;
  axis_data.Box = axis_data.box;
  axis_data.XScale = axis_data.xscale;
  axis_data.XLim = axis_data.xlim;
  axis_data.XDir = axis_data.xdir;
  axis_data.YDir = axis_data.ydir;
  axis_data.XTick = axis_data.xtick;
  axis_data.XTickLabelMode = axis_data.xticklabelmode;
  axis_data.XTickLabel = axis_data.xticklabel;
  axis_data.XLim = axis_data.ylim;
  axis_data.YScale = axis_data.yscale;
  axis_data.YLim = axis_data.ylim;
  axis_data.YTick = axis_data.ytick;
  axis_data.YTickLabelMode = axis_data.yticklabelmode;
  axis_data.YTickLabel = axis_data.yticklabel;
  axis_data.YLim = axis_data.ylim;
  axis_data.TickDir = axis_data.tickdir;
  axis_data.UserData = axis_data.userdata;
  axis_data.Visible = axis_data.visible;
  axis_data.YLabel = axis_data.ylabel;
  axis_data.XLabel = axis_data.xlabel;
end
...
if( exist( 'OCTAVE_VERSION', 'builtin' ) )
  xlabel_data.String = xlabel_data.string;
  xlabel_data.Color = xlabel_data.color;
  xlabel_data.Interpreter = xlabel_data.interpreter;
  xlabel_data.FontSize = xlabel_data.fontsize;
  xlabel_data.FontName = xlabel_data.fontname;
  ylabel_data.String = ylabel_data.string;
  ylabel_data.Color = ylabel_data.color;
  ylabel_data.Interpreter = ylabel_data.interpreter;
  ylabel_data.FontSize = ylabel_data.fontsize;
  ylabel_data.FontName = ylabel_data.fontname;
end
